...
describe('Setup ', function () {
    ...
    describe('Archive Test Suite ', function () {
        ...
        it('Programs - Filter - Displayed ', async function () {
            await page.goto(testconfig.resources.dailyLessonUrl, {waitUntil: 'domcontentloaded'});
            // choose Programs section from vertical menu
            await page.click('.ui.blue.huge.borderless.fluid.vertical.menu a.item:nth-child(2)');
            // header
